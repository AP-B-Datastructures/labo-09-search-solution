...
namespace Search.tests
{
    ...
    public class SinglyLinkedList_Tests
    {
        ...
        public void Remove_RemovesElementAtIndex()
        {
            ...
            // Act
            NodeInt removed = _list.Remove(1);
        ...
        public void RemoveFirst_RemovesFirstNode()
        {
            ...
            // Act
            NodeInt removed = _list.RemoveFirst();
        ...
        public void RemoveLast_RemovesLastNode()
        {
            ...
            // Act
            NodeInt removed = _list.RemoveLast();
